...
- [x] **Fix global clean selectedAreas empty-input bug (Bug A)** — added updateAttribute call in SELECT_AREAS handler empty-input branch to echo back resolved all-rooms list to Matter after resolveAllRoomsForActiveMap
