...
${row('b01-map-parser-test', '--duid <duid>', 'Test B01 map parser Q7/Q10 classifier against a live device (experimental, diagnostic)')}
...
${b}Examples:${r}
  ...
  npm run cli -- --command ${g}b01-map-parser-test${r}  --duid ${c}<duid>${r}
